"""
TicTacToe specific tester implementation for ProxyWar framework.
"""
...
class TicTacToeTester(BaseTester):
    """TicTacToe specific code tester."""
    
    def __init__(self):
        super().__init__("TicTacToeTester")
    
    def _test_agent_code_impl(self, agent_code_path: str, agent_name: str) -> TestSuite:
        """Test the generated TicTacToe agent code."""
    ...
    def _test_basic_behavior(self, agent_instance: BaseAgent) -> None:
        ...
        try:
            observation = [0, 0, 0, 0, 0, 0, 0, 0, 0]  # Empty board
            action_mask = [True] * 9  # All positions available
